...
- 生成:2026-09-18 18:43(工具:`ferryman e0c`)
- 数据:293 个会话(终值 290,在跑 3),扫描根:C:\Users\allan716\.claude\projects
...
| 行 | 类型 | 深度 | 模型 | 终态 | 响应 | input | output | 缓存写 | 缓存读 | subtree(input/output/缓存写/缓存读) |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
| 主会话 | — | — | GLM-5.3 | 终值 | 7 | 15,236 | 6,908 | 0 | 285,760 | — |
...
| 行 | 类型 | 深度 | 模型 | 终态 | 响应 | input | output | 缓存写 | 缓存读 | subtree(input/output/缓存写/缓存读) |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
| 主会话 | — | — | GLM-5.3 | 终值 | 78 | 452,192 | 98,683 | 0 | 14,251,392 | — |
| `a3b6fec35391b6408` | general-purpose | 1 | sonnet | 完成 | 4 | 64,782 | 11,628 | 0 | 128,832 | 64,782 / 11,628 / 0 / 128,832 |
| `a4bc5ad00e8f0b6c3` | general-purpose | 1 | sonnet | 完成 | 5 | 80,880 | 19,924 | 0 | 223,424 | 80,880 / 19,924 / 0 / 223,424 |
| `a7c9de3822e37a059` | general-purpose | 1 | sonnet | 中断 | 16 | 140,309 | 1,808 | 0 | 1,268,800 | 140,309 / 1,808 / 0 / 1,268,800 |
...
| `adeaf77f867d1fe5a` | general-purpose | 1 | sonnet | 完成 | 49 | 158,716 | 37,605 | 0 | 5,054,336 | 158,716 / 37,605 / 0 / 5,054,336 |
| `adeafd782f32b4530` | general-purpose | 1 | sonnet | 完成 | 57 | 315,501 | 35,559 | 0 | 6,706,432 | 315,501 / 35,559 / 0 / 6,706,432 |
| `af7a138c67cd8760e` | general-purpose | 1 | haiku | 完成 | 8 | 46,852 | 8,188 | 0 | 286,656 | 46,852 / 8,188 / 0 / 286,656 |

- 会话总账(主 + Σ 子 self,含嵌套不双计):input 1,509,063 / output 243,967 / 缓存写 0 / 缓存读 31,016,896
- 交叉校验:direct 口径:主转录 Agent/Task 调用 9 次 / depth=1 meta 9 条 / depth=1 转录 9 份 — 一致
- 交叉校验:total 口径:各父转录直接子调用合计 9 次 / total spawn 事件 9 次(未知深度 0 条)— 一致
...
| 行 | 类型 | 深度 | 模型 | 终态 | 响应 | input | output | 缓存写 | 缓存读 | subtree(input/output/缓存写/缓存读) |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
| 主会话 | — | — | GLM-5.3 | 终值 | 8 | 14,589 | 5,015 | 0 | 338,048 | — |

- 会话总账(主 + Σ 子 self,含嵌套不双计):input 14,589 / output 5,015 / 缓存写 0 / 缓存读 338,048
- 交叉校验:direct 口径:主转录 Agent/Task 调用 0 次 / depth=1 meta 0 条 / depth=1 转录 0 份 — 一致
- 交叉校验:total 口径:各父转录直接子调用合计 0 次 / total spawn 事件 0 次(未知深度 0 条)— 一致
...
| 行 | 类型 | 深度 | 模型 | 终态 | 响应 | input | output | 缓存写 | 缓存读 | subtree(input/output/缓存写/缓存读) |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
| 主会话 | — | — | GLM-5.3 | 终值 | 110 | 844,882 | 156,234 | 0 | 22,766,336 | — |
...
| `a33cd3c19c440fa06` | general-purpose | 1 | sonnet | 完成 | 14 | 105,059 | 23,854 | 0 | 762,752 | 105,059 / 23,854 / 0 / 762,752 |
...
| `a533873e75125c40a` | general-purpose | 1 | sonnet | 完成 | 30 | 200,815 | 24,663 | 0 | 2,432,640 | 200,815 / 24,663 / 0 / 2,432,640 |
| `a57087713da97b2f6` | general-purpose | 1 | sonnet | 完成 | 23 | 85,537 | 26,609 | 0 | 1,228,544 | 85,537 / 26,609 / 0 / 1,228,544 |
...
| `af111e193343d8820` | general-purpose | 1 | opus | 完成 | 29 | 155,696 | 27,955 | 0 | 2,504,256 | 155,696 / 27,955 / 0 / 2,504,256 |
...
- 会话总账(主 + Σ 子 self,含嵌套不双计):input 2,131,070 / output 414,667 / 缓存写 0 / 缓存读 37,297,408
- 交叉校验:direct 口径:主转录 Agent/Task 调用 15 次 / depth=1 meta 15 条 / depth=1 转录 15 份 — 一致
- 交叉校验:total 口径:各父转录直接子调用合计 15 次 / total spawn 事件 15 次(未知深度 0 条)— 一致
...
| `075a88c4-4674-4fb8-8339-38582a7993c0` | 14,589 | 5,015 | 0 | 338,048 | 台账规则:同 transcript_path 出现新 session_id(识别未验证) |
...
| `1523f5dd-a517-43c8-a33c-595228b32523` | 1,509,063 | 243,967 | 0 | 31,016,896 | 台账规则:同 transcript_path 出现新 session_id(识别未验证) |
...
| `54707189-7f66-497e-9cb5-668f46a41163` | 2,131,070 | 414,667 | 0 | 37,297,408 | 台账规则:同 transcript_path 出现新 session_id(识别未验证) |
...
| `f4517620-db18-4a45-af83-248ac6c3d3e0` | 15,236 | 6,908 | 0 | 285,760 | 台账规则:同 transcript_path 出现新 session_id(识别未验证) |
...
| 行 | 类型 | 深度 | 模型 | 终态 | 响应 | input | output | 缓存写 | 缓存读 | subtree(input/output/缓存写/缓存读) |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
| 主会话 | — | — | GLM-5.3 | 在跑(非终值) | 66 | 155,262 | 91,332 | 0 | 7,738,048 | — |
| `a0500b15611bf7dfd` | general-purpose | 1 | haiku | 完成 | 5 | 13,124 | 2,662 | 0 | 151,360 | 13,124 / 2,662 / 0 / 151,360 |
| `a0548fa2192a85f9b` | general-purpose | 1 | haiku | 完成 | 5 | 10,932 | 2,532 | 0 | 149,632 | 10,932 / 2,532 / 0 / 149,632 |
| `a27615a4e09a1cd63` | general-purpose | 1 | sonnet | 在跑(非终值) | 11 | 30,072 | 15,530 | 0 | 443,712 | 30,072 / 15,530 / 0 / 443,712 |
| `a39a8f90cbe70aebc` | general-purpose | 1 | haiku | 完成 | 6 | 41,749 | 2,366 | 0 | 162,048 | 41,749 / 2,366 / 0 / 162,048 |
| `a8f172d96d347f463` | general-purpose | 1 | haiku | 完成 | 6 | 40,073 | 4,972 | 0 | 167,104 | 40,073 / 4,972 / 0 / 167,104 |
| `aaab03526509c3ec4` | general-purpose | 1 | sonnet | 完成 | 10 | 93,395 | 8,663 | 0 | 305,472 | 93,395 / 8,663 / 0 / 305,472 |
| `abdc17f3474c32bc7` | general-purpose | 1 | haiku | 完成 | 6 | 42,509 | 3,536 | 0 | 158,848 | 42,509 / 3,536 / 0 / 158,848 |
| `aca2aa923970c3472` | general-purpose | 1 | haiku | 完成 | 4 | 60,961 | 2,849 | 0 | 69,696 | 60,961 / 2,849 / 0 / 69,696 |
| `af8d9e57f3eea2e0a` | general-purpose | 1 | sonnet | 在跑(非终值) | 0 | 0 | 0 | 0 | 0 | 0 / 0 / 0 / 0 |

- 会话总账(主 + Σ 子 self,含嵌套不双计):input 488,077 / output 134,442 / 缓存写 0 / 缓存读 9,345,920
- 交叉校验:direct 口径:主转录 Agent/Task 调用 9 次 / depth=1 meta 9 条 / depth=1 转录 9 份 — 一致
- 交叉校验:total 口径:各父转录直接子调用合计 9 次 / total spawn 事件 9 次(未知深度 0 条)— 一致
...
| 行 | 类型 | 深度 | 模型 | 终态 | 响应 | input | output | 缓存写 | 缓存读 | subtree(input/output/缓存写/缓存读) |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
| 主会话 | — | — | GLM-5.3 | 在跑(非终值) | 66 | 186,699 | 116,535 | 0 | 8,803,392 | — |
...
| `a4f3a8df7bb1da98b` | general-purpose | 1 | sonnet | 在跑(非终值) | 46 | 210,618 | 49,047 | 0 | 4,150,400 | 210,618 / 49,047 / 0 / 4,150,400 |
| `a64db717cb7ef2136` | general-purpose | 1 | haiku | 完成 | 4 | 100,363 | 2,972 | 0 | 27,392 | 100,363 / 2,972 / 0 / 27,392 |
| `a94d95daf9fa2bd9f` | general-purpose | 1 | sonnet | 完成 | 15 | 144,074 | 27,022 | 0 | 715,520 | 144,074 / 27,022 / 0 / 715,520 |
| `abd127490155e178f` | general-purpose | 1 | haiku | 完成 | 5 | 42,629 | 2,837 | 0 | 125,952 | 42,629 / 2,837 / 0 / 125,952 |
| `af70ed39d2e089a07` | general-purpose | 1 | sonnet | 完成 | 12 | 57,244 | 13,371 | 0 | 504,640 | 57,244 / 13,371 / 0 / 504,640 |

- 会话总账(主 + Σ 子 self,含嵌套不双计):input 896,739 / output 227,489 / 缓存写 0 / 缓存读 15,406,848
- 交叉校验:direct 口径:主转录 Agent/Task 调用 8 次 / depth=1 meta 8 条 / depth=1 转录 8 份 — 一致
- 交叉校验:total 口径:各父转录直接子调用合计 8 次 / total spawn 事件 8 次(未知深度 0 条)— 一致
...
| 行 | 类型 | 深度 | 模型 | 终态 | 响应 | input | output | 缓存写 | 缓存读 | subtree(input/output/缓存写/缓存读) |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
| 主会话 | — | — | GLM-5.3 | 在跑(非终值) | 130 | 650,369 | 124,261 | 0 | 19,688,256 | — |
| `a0d2941a282ef1827` | general-purpose | 1 | sonnet | 在跑(非终值) | 40 | 95,704 | 21,566 | 0 | 2,941,696 | 95,704 / 21,566 / 0 / 2,941,696 |
...
| `a47b276918310cb6c` | general-purpose | 1 | sonnet | 完成 | 63 | 299,327 | 55,350 | 0 | 5,937,152 | 299,327 / 55,350 / 0 / 5,937,152 |
| `a480bd46d3d2f1738` | general-purpose | 1 | sonnet | 完成 | 15 | 152,702 | 27,083 | 0 | 984,128 | 152,702 / 27,083 / 0 / 984,128 |
...
| `a9e43d99db3a953cd` | general-purpose | 1 | sonnet | 完成 | 30 | 106,924 | 19,513 | 0 | 1,706,112 | 106,924 / 19,513 / 0 / 1,706,112 |
...
| `ac69df738f8a7f625` | general-purpose | 1 | opus | 完成 | 22 | 99,560 | 27,791 | 0 | 1,498,112 | 99,560 / 27,791 / 0 / 1,498,112 |
...
- 会话总账(主 + Σ 子 self,含嵌套不双计):input 2,597,652 / output 488,813 / 缓存写 0 / 缓存读 43,086,848
- 交叉校验:direct 口径:主转录 Agent/Task 调用 16 次 / depth=1 meta 16 条 / depth=1 转录 16 份 — 一致
- 交叉校验:total 口径:各父转录直接子调用合计 16 次 / total spawn 事件 16 次(未知深度 0 条)— 一致
...
|---|---:|---:|---:|---:|
| 主会话合计 | 192,456,455 | 26,487,545 | 213,487 | 6,709,879,699 |
| 子代理合计(self) | 102,452,283 | 23,714,285 | 0 | 2,014,876,736 |
| 总账 | 294,908,738 | 50,201,830 | 213,487 | 8,724,756,435 |
| 子代理占比 | 34.7% | 47.2% | 0.0% | 23.1% |
...
|---|---:|---:|---:|---:|---:|
| Explore | 24 | 2,296,326 | 318,966 | 0 | 33,261,248 |
...
| general-purpose | 1247 | 89,131,848 | 20,958,543 | 0 | 1,818,071,872 |

### 按深度(spawnDepth,未知桶单列)

| 分组 | 行数 | input | output | 缓存写 | 缓存读 |
|---|---:|---:|---:|---:|---:|
| 1 | 1432 | 99,287,366 | 22,733,526 | 0 | 1,968,568,000 |
...
|---|---:|---:|---:|---:|
| GLM-5.3 | 37,782,647 | 5,987,529 | 0 | 1,034,499,456 |
...
| glm-5.3-flash | 67,974,768 | 12,862,286 | 0 | 1,036,531,456 |

## Q3 · 与 CLI 自报数对账

- 手记:`C:/Users/allan716/orca/workspaces/Ferryman/subagent监控/.xcheck/20260918-151538/recon-notes.jsonl`(有效 21 条,坏行 0 条)
- 残差口径=in+out(与 CLI 自报语义对齐;四列口径另列仅作参考)。
- 机制注记(终局评审抽查 4 例验证):自报值与末次请求 context 规模(input+cache_read)吻合 0.5%~3%,疑为“结束时上下文规模”语义,与文件侧“逐请求累计”是不同的量;长 agent 残差因此必然放大,判据一不能经手记通道认证。

| agentId | 类型 | 自报总量 | 文件四列合计(参考) | 文件 in+out | 残差(in+out) | 残差率 | 备注 |
|---|---|---:|---:|---:|---:|---:|---|
| `a1ec147dd4f7a81f0` | Explore | 75,395 | 762,208 | 74,016 | 1,379 | +1.8% | 在跑会话快照 |
| `a84478bc85bff9c18` | carrier(codex r0) | 39,776 | 185,258 | 41,322 | -1,546 | -3.9% | 在跑会话快照 |
| `ae403b8e672237d17` | carrier(pi r0) | 40,138 | 223,817 | 41,993 | -1,855 | -4.6% | 在跑会话快照 |
| `afe934b46d0893568` | carrier(codex r1) | 40,413 | 187,133 | 47,101 | -6,688 | -16.5% | 在跑会话快照 |
| `a4cc2e7381a796c28` | carrier(pi r1) | 40,494 | 187,798 | 39,126 | 1,368 | +3.4% | 在跑会话快照 |
| `a20df93958b185b64` | implementer(ticket01) | 64,377 | 961,271 | 98,231 | -33,854 | -52.6% | 在跑会话快照 |
| `ac0a930fdf75c0695` | reviewer(ticket01) | 70,809 | 530,534 | 87,782 | -16,973 | -24.0% | 在跑会话快照 |
| `a779dceb0c97e33bd` | implementer(ticket02) | 85,242 | 2,141,325 | 281,101 | -195,859 | -229.8% | 在跑会话快照 |
| `acf6a35775f7aa1e4` | reviewer(ticket02) | 78,654 | 1,277,626 | 184,634 | -105,980 | -134.7% | 在跑会话快照 |
| `a779dceb0c97e33bd` | implementer(ticket02 R1) | 96,294 | 2,141,325 | 281,101 | -184,807 | -191.9% | 在跑会话快照 |
| `acf6a35775f7aa1e4` | reviewer(ticket02 re-review) | 87,243 | 1,277,626 | 184,634 | -97,391 | -111.6% | 在跑会话快照 |
| `ab24ad7f24ade4808` | implementer(ticket03) | 103,997 | 3,837,889 | 297,217 | -193,220 | -185.8% | 在跑会话快照 |
| `ab2816da299c7a3a3` | reviewer(ticket03) | 86,441 | 1,442,848 | 213,792 | -127,351 | -147.3% | 在跑会话快照 |
| `ab24ad7f24ade4808` | implementer(ticket03 R1) | 110,749 | 3,837,889 | 297,217 | -186,468 | -168.4% | 在跑会话快照 |
| `ab2816da299c7a3a3` | reviewer(ticket03 re-review) | 91,602 | 1,442,848 | 213,792 | -122,190 | -133.4% | 在跑会话快照 |
| `a47b276918310cb6c` | implementer(ticket04) | 110,388 | 6,291,829 | 354,677 | -244,289 | -221.3% | 在跑会话快照 |
| `a480bd46d3d2f1738` | reviewer(ticket04) | 91,299 | 1,163,913 | 179,785 | -88,486 | -96.9% | 在跑会话快照 |
| `a9e43d99db3a953cd` | implementer(ticket05) | 102,868 | 1,832,549 | 126,437 | -23,569 | -22.9% | 在跑会话快照 |
| `a47b276918310cb6c` | implementer(ticket04 R1) | 126,035 | 6,291,829 | 354,677 | -228,642 | -181.4% | 在跑会话快照 |
| `a480bd46d3d2f1738` | reviewer(ticket04 re-review) | 101,844 | 1,163,913 | 179,785 | -77,941 | -76.5% | 在跑会话快照 |
| `ac69df738f8a7f625` | final-reviewer(branch) | 107,833 | 1,625,463 | 127,351 | -19,518 | -18.1% | 在跑会话快照 |
...
| 类别 | 数量 | 分母 | 占比 |
|---|---:|---:|---:|
| 中断(子代理终态) | 2 | 1508(子代理行) | 0.1% |
| 空文件(子代理终态) | 0 | 1508(子代理行) | 0.0% |
| 在跑(子代理,非终值) | 4 | 1508(子代理行) | 0.3% |
| 在跑会话(整场非终值) | 3 | 293(会话) | 1.0% |
| 有 meta 无转录(不成对) | 0 | 1508(子代理行) | 0.0% |
| 有转录无 meta(未知桶,不成对) | 0 | 1508(子代理行) | 0.0% |
| 无 message.id 行 | 0 | 1801(转录文件) | 0.0% |
| 坏行/半行 JSON | 0 | 1801(转录文件) | 0.0% |
| 组内非零 usage 冲突 | 0 | 1801(转录文件) | 0.0% |
| 全零占位组 | 810 | 1801(转录文件) | 45.0% |
...
- 判据一(口径可信):Q3 残差率(in+out 口径)多数 ≤5% 且无 >10% 离群 → 文件侧 in+out 口径可作对账权威;出现 >10% 离群先解释再议(spec 已知残差未解释,见 Q3)。本机实测:残差率最大 229.8%(n=21)。
- 判据二(功能价值):若子代理占比可观(参考:output 列 ≥20%)且会话平均 spawn 数不小(本机实测:终值会话平均 5.1 次/会话,计 1,475 次),记账入正式功能才有信息收益;两值都低则留实验记录即可。
