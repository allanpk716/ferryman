...
- [x] E1 基建 + 本地网关候选实测（③续接 15/15、防注入通过、SLA 校准 L1 9-78s / L2 217-252s；评测产物含本机会话内容不入库，本地跑 eval 复现）——待 DeepSeek/GLM key 横评定路由
...
uv run ferryman eval --provider <providers 名> [--regrade]
